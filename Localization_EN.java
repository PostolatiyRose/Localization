...
*/
        ...
        WebElement web_15 = driver.findElement(By.xpath("//*[@id=\"cardDataSubmit\"]"));// >> Proceed
        String s15 = web_15.getAttribute("value");
        String d15 = s15.replace(">>", "");
        System.out.println(d15);
        resultList_EN.add(d15);

        driver.findElement(By.id("cardDataSubmit")).click(); //подтверждение

        //Идентефикация элементов на 2 странице
